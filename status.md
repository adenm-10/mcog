...
transfer step. Floors, regenerated by `tools/make_v35_floor.sh` before the sweep
...
- **MAKING A TASK MORE FAITHFUL CAN DESTROY THE METRIC. FLOOR IT FIRST.** Scoring a crossing
  ...
  change, before the sweep. 4 cells, ~3 minutes** (`tools/make_v32_floor.sh`). A floor is
